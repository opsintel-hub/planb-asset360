...
export function mapCrmRow(item: Record<string, unknown>, syncedAt: string): AdContractRow | null {
  ...
  return {
    ...
    brand: pickStr(item, ["brand", "Brand", "brand_th", "brandName"]),
    brand_eng: pickStr(item, ["brand_eng", "brandEng", "BrandEng", "brand_en", "BrandEnglish"]),
    package_name: pickStr(item, ["package_name", "packageName", "PackageName"]),
    package_code: pickStr(item, ["package_code", "packageCode", "PackageCode"]),
