CREATE OR REPLACE FUNCTION public.refresh_pm_views()
 ...
 SET idle_in_transaction_session_timeout TO '600s'
AS $function$
BEGIN
...
CREATE INDEX IF NOT EXISTS idx_mssql_asset_history_old_code ON public.mssql_asset_history (old_code);
CREATE INDEX IF NOT EXISTS idx_assets_old_code ON public.assets (old_code);
CREATE INDEX IF NOT EXISTS idx_mv_pm_history_type_asset ON public.mv_pm_history (type, asset_old_code);