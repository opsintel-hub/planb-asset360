import { RiskPmQueue } from "@/components/asset-risk";
...
import { BarChart3, Wrench, Monitor, PackageOpen, RefreshCw, AlertCircle, ChevronDown, ChevronUp, X } from "lucide-react";
...
function PmInsightsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Phase 5 — PM queue ordered by risk (hidden for sale/CRM roles) */}
      <RiskPmQueue limit={12} />
    ...
    <Card>
      <CardHeader>
        ...
        <div className="text-sm text-muted-foreground mt-1 space-y-1">
          <p>นับตั๋วของปี {year} โดยอิงวันที่แบบเดียวกับเมนู <b>Asset history</b>:</p>
